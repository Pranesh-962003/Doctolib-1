  ...
  const getAvailabelSlot = async () =>{
    ...
    for(let i=0 ; i<7; i++){
      ...
      while(currentDate < endTime){
        ...
        const isSlotAvailabel = docInfo.slots_booked[slotDate] && docInfo.slots_booked[slotDate].includes(slotTime) ? false : true
